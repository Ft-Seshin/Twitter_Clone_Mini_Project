...
import tech.codingclub.tables.Music;
...
public class GenericDB<T> {
    ...
    public static List<?> getRows(Music table, Class<?> converterClass, Condition condition, Integer limit) {
    ...
    public T getRow(Music table, Class<?> converterClass, Condition condition) {
